...
const tenants = [
  ...
  },
  {
    ...
    property: "Desert Springs Residences",
    unit: "",
    moveIn: "12-09-2023",
    type: "Residential" as PropertyType
  },
  {
    ...
    property: "Tropical Paradise Suites",
    unit: "204-A",
    moveIn: "25-12-2023",
    type: "Commercial" as PropertyType
  }
          ...
          <TableBody>
            {tenants.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell>
                  <Button size="icon" variant="ghost" link="/tenants/1">
