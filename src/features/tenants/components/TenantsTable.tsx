...
const TenantsTable = () => {
  ...
  const { data: response, isLoading } = useQuery({
    queryKey: queryKeys.tenants.list("active", queryParams),
    queryFn: () => getTenantList({ status: "active", ...queryParams })
  });
  ...
  const dateRangeLabel =
    dateFrom || dateTo
      ? [
          dateFrom ? moment(dateFrom).format("DD MMM") : "Start",
          dateTo ? moment(dateTo).format("DD MMM") : "End"
        ].join(" – ")
      : "Date Range";
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <DateSelector
            ...
            trigger={
              ...
              >
                {dateFrom ? moment(dateFrom).format("DD MMM YY") : "From Date"}
            ...
            <TableRow>
              <TableCell colSpan={5}>
                <div className="flex flex-col items-center justify-center gap-2 py-14 text-center">
                  <Users className="size-8 text-brand-Text-300" />
