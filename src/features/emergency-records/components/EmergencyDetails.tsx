...
const Divider = () => <div className="self-stretch h-px bg-brand-Text-100" />;
...
const EmergencyDetails = () => (
  <div className="w-full p-6 bg-brand-base-white rounded-[20px] shadow-[0px_1px_10px_0px_rgba(0,0,0,0.08)] outline outline-1 outline-offset-[-1px] outline-brand-Text-100 flex flex-col gap-6">
    ...
    <div className="flex flex-col gap-3">
      ...
      <DetailRow
        label="Issue Summary"
        value="Water leak in bathroom ceiling. Water dripping from light fixture and spreading to adjacent rooms."
      />
    </div>
  </div>
);
